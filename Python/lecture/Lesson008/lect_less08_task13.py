...
with open(f'{direct}/biostats_tab.csv', 'r', newline='') as f_read,\
    open(f'{direct}/biostats_new.csv', 'w', newline='', encoding='utf-8') as f_write:
    ...
    csv_write.writeheader() # Записывает заголовки
    all_data = []
